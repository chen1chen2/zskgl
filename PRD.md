...
| 备注             | 输入框 | 术语库概述                     | 选填，最大200个字符                                                                                                                                                                                                                                                          |
| 导入文件         | 上传区 | 可选，支持文件、文件夹、拖拽   | 详见 5.4 上传规则                                                                                                                                                                                                                                                            |
| 批量设置涉密等级 | 下拉框 | 为上传文件列表统一设置文件密级 | ***可选密级≤知识库的密级<br />当系统配置支持密级修改，则可所有文件进行密级修改<br />当系统配置不支持密级修改，则只可修改未设置密级的文件的密级***<br /><br />***已经上传文件且设置了密级，再修改库密级，且存在文件密级大于库密级，系统给出弹窗提示xxxxxx*** |
...
![1782095981852](image/PRD/1782095981852.png)
...
![1782096056451](image/PRD/1782096056451.png)
...
4. ***管理者：拥有最高权限(只有库的创建者、企业的管理员可清空库与删除库)***
5. ***超级管理员拥有商户的所有的知识库的管理者权限***
6. ***协作弹窗中的人员、角色、团队，最终匹配到的人员需要小于等于知识库的密级***
